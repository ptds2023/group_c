...
```
<p style="text-align:center; font-size:70%;">Bourleau Marc<br/>Team Manager</p>
```{r echo=FALSE, out.width='40%', fig.align='center'}
...
```
<p style="text-align:center; font-size:70%;">Kourlimpinis Konstantinos<br/>Web Designer</p>
]
...
.pull-left[
## Goals
- Provide a clear overview (contactless payment, card payment, etc.)
...
.pull-left[
![an image](pictures/Collection.png)
]
...
- Creation of a data base for the shiny app
]

.pull-right[
![an image](pictures/Transformation.png)
]
...
.pull-left[
From this...
![an image](pictures/nonoptimization.png)
]

.pull-right[
To this !

![an image](pictures/optimization.png)
]
---
class: left
...
.pull-left[
And from this...
![an image](pictures/nonoptimization2.png)
]

.pull-right[
To this !

![an image](pictures/optimization2.png)
]
---
# Optimization & Package Creation
