...
# These categories are identical to the ones we extracted from moneyland.ch
categories <- c(
  "Mandatory transfer expenses (AVS, etc.)",
  "Housing and energy (primary residence)",
  "Food",
  "Restaurants and accommodation",
  "Purchase and use of private vehicles",
  "Entertainment, leisure, culture",
  "Additional insurance",
  "Life insurance",
  "Health expenses",
  "Donations, gifts, invitations",
  "Transportation services",
  "Clothing and shoes",
  "Communications",
  "Alimony and support contributions",
  "Interior fittings",
  "Alcoholic beverages and tobacco",
  "Fees",
  "Non-alcoholic beverages",
  "Household current expenses",
  "School and training fees",
  "Housing and energy (secondary residence)",
  "Other goods and services"
)

# Swiss average expenses (monthly)
# These values were scrapped from moneyland.ch to get the swiss average expenditures
swiss_expenses <- c(
  2800, 1345, 580, 558, 533, 510, 313, 282, 245, 199, 177, 175, 174, 173, 164, 95, 67, 56, 46, 45, 36, 245
)
...
ui <- dashboardPage(
  ...
  dashboardBody(
    # Main body with tabs for different views
    tabsetPanel(
      tabPanel("Summary",
      # Summary tab with visualizations and editable table
               fluidRow(
      ...
      # Compare to the average tab for comparison with Swiss averages
...
server <- function(input, output, session) {
  # Initialize reactive values for expenses and selected categories
  expenses_data <- reactiveVal(data.frame(category = character(), amount = numeric()))
  selected_categories <- reactiveVal(character())

  # Observe add_expense button click -> "add expense" when button is clicked
  ...
  # Update scatter plot for expense comparison
  observe({
